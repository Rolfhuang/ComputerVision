...
def main():
    ...
    img1_filename = r'./1.png'
    img2_filename = r'./2.png'
    ...
    # # cv2.imshow("Circle", replaced_img_circle)
    # # cv2.waitKey(0)
    ...
    # # # 4c
    # shift_green = shift_image_left(img1_green, 50)
    # # cv2.imshow("Circle", shift_green)
    # # cv2.waitKey(0)
    # cv2.imwrite('ps1-4-c-1.png', shift_green)

    # # # 4d
    # diff_green = difference_image(img1_green, shift_green)
    # # cv2.imshow("Circle", diff_green)
    # # cv2.waitKey(0)
